...
module Burrow.Framework.Mapping
  (LabelSrc : Set) {LabelDst : Set}
  {{_ :  LabelClass LabelSrc}} {{_ : LabelClass LabelDst}}
...
import Burrow.Framework.General LabelSrc dst dst-wf as Ψ
