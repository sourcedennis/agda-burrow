...
module Burrow.Framework.General (LabelSrc : Set) {{_ : LabelClass LabelSrc}}
  {LabelDst : Set} {{_ : LabelClass LabelDst}}
  (dst : Ex.Execution LabelDst) (dst-wf : Ex.WellFormed dst) where
...
-- Local imports: Other
open import Burrow.Internal.Helpers using (contrapositive)
